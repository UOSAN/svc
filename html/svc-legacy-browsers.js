import * as core from "./lib/core-2020.1";
import * as util from "./lib/util-2020.1";
import {PsychoJS} from "./lib/core-2020.1";
...
function block_instructionsRoutineBegin(trials) {
  return function () {
    ...
    block_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
